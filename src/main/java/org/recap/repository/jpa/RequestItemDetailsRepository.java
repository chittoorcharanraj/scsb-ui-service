...
public interface RequestItemDetailsRepository extends BaseRepository<RequestItemEntity> {
     ...
     */
    @Query(value = "SELECT REQUEST_TYPE_T.REQUEST_TYPE_CODE, REQUEST_ITEM_T.REQUESTING_INST_ID, ITEM_T.OWNING_INST_ID, ITEM_T.COLLECTION_GROUP_ID, ITEM_T.BARCODE, REQUEST_ITEM_T.CREATED_DATE,REQUEST_ITEM_STATUS_T.REQUEST_STATUS_CODE,ITEM_T.IMS_LOCATION_ID,ITEM_T.CALL_NUMBER" +
            " FROM  REQUEST_ITEM_T" +
            "    INNER JOIN ITEM_T ON REQUEST_ITEM_T.ITEM_ID = ITEM_T.ITEM_ID " +
